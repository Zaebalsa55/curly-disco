...
export function LoadingScreen({ onComplete }: { onComplete: () => void }) {
  ...
  useEffect(() => {
    // Предзагружаем основные ресурсы сайта
    const preloadResources = () => {
      const images = [
        "/images/washing-machine-reference.png",
        "/images/repairman-portrait.png",
        "/images/brands-showcase.png",
        "/images/stepper-step1.jpg",
        "/images/stepper-step2.jpg",
        "/images/stepper-step3.jpg",
      ]
    ...
    >
      <div className="relative w-full h-full flex items-center justify-center">
        <svg
          ...
          className="w-[60%] sm:w-[40%] md:w-[30%] h-auto opacity-100"
